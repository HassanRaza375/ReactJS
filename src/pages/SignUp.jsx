...
const SignUp = () => {
    ...
    const SignUpHandler = async () => {
        const res = await axios.post('http://localhost:5000/api/auth/signup', { name: name.current.value, email: email.current.value, password: password.current.value })
                        ...
                        <div className="flex items-center flex-col justify-center h-[100vh] p-[20px]">
                            <div className="w-full max-w-[460px]">
                                ...
                                <div className="mt-[1rem]">
                                    ...
                                    <div className="flex gap-[11px] bg-[#261046] rounded-[10px] text-[#A4A4A4] px-[22px] py-[10px] items-center mt-2">
                                        <img
                                    ...
                                    <button className="cursor-pointer bg-gradient-to-r from-[#501794] to-[#3E70A1] p-[15px] w-[100%] rounded-[18px] mt-[22px] mb-[20px]" onClick={() => SignUpHandler()}>
                                        Sign up
                                    </button>
                                </div>
                                <div>
